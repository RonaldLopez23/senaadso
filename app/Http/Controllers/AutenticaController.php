...
class AutenticaController extends Controller
{
    public function registro(Request $request)
    {
        ...
        return redirect()->route('login')->with('info', 'Registro exitoso. Por favor inicia sesión.');
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            return redirect()->intended('productos')->with('info', 'Inicio de sesión exitoso');
        }
    ...
    public function passwordUpdate(Request $request, User $user)
    {
        $request->validate([
            ...
            'password_old.required' => 'La contraseña actual es requerida',
            'password.required' => 'La contraseña es obligatoria',
            'password.min' => 'La contraseña debe tener al menos 5 caracteres',
            'password.confirmed' => 'Las contraseñas no coinciden'
        ]);
