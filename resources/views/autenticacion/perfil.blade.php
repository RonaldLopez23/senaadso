        ...
        <div class="card-body">
            ...
            <form action="{{ route('perfil.update', $user) }}" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="name" placeholder="Ingrese su nombre" value="{{ $user->name }}">
                </div>
                ...
                <div class="form-control">
                    ...
                    <input type="email" name="email" placeholder="Ingrese su correo electrónico" value="{{ $user->email }}">
                </div>
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="address" placeholder="Ingrese su dirección" value="{{ $user->address }}">
                </div>

                {{-- Botón Actualizar --}}
                <div class="form-control mt-6 w-1/2">
                    <button type="submit" class="btn btn-sm btn-neutral">Actualizar</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('password.update', $user) }}" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="password" name="password_old" placeholder="Ingrese su contraseña actual">
                </div>
                ...
                <div class="form-control mt-6 w-1/2">
                    <button type="submit" class="btn btn-sm btn-neutral">Cambiar contraseña</button>
                </div>
            </form>
        </div>
    </div>
